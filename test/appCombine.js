...
contract('combineApp', accounts => {
    ...
    it('should deploy combineApp with initial deposit of 125', async () => {
        ...
        let proxyApp = await pF.initialize(pool_ID,exchangeName,{value: amt(125)});
    ...
    it("Should not allow reinitialization", async() => {
        try {
            ...
            let rv = await app.initialize(pool_ID-1, '0x2320738301305c892B01f44E4E9854a2D19AE19e', exchangeName, accounts[0]);
            console.log(rv);
    ...
    it("Should restrict admin functions", async() => {
        ...
        try {
            await app.setPool(pool_ID, exchangeName,400, { from: accounts[3] });
        ...
        try {
            await app.swapPool(pool_ID, exchangeName,400, { from: accounts[3] });

...
interface iBeacon {
    ...
    function getExchangeInfo(string memory _name) external view returns(address _chefContract, address _routerContract, address _rewardToken, string calldata _pendingCall, address intermediateToken);
